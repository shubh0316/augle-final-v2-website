...
export default function ExplorerPage() {
  return (
    <div className="flex flex-col md:h-[calc(100vh-4rem)] md:overflow-hidden">
      <div className="flex-shrink-0 border-b border-border bg-paper px-5 pt-3.5 pb-3 md:px-10 lg:px-[72px]">
        <div className="mb-1 font-mono text-[10px] leading-none tracking-[0.08em] text-rust uppercase">
          Augle Deliberation Index
        </div>
        <div className="mb-0.5 font-serif text-[22px] leading-none text-ink">Question explorer</div>
